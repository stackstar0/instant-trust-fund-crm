...
const partners = [
  "LIC", "PolicyBazaar", "SBI", "HDFC", "ICICI", "Axis", "Kotak Mahindra",
  "Bajaj Finserv", "Tata Capital", "Godrej Capital", "Poonawalla Fincorp",
  "Piramal Finance", "L&T Finance", "Credila", "Avanse", "Auxilo", "InCred",
  "Protium", "Unity", "Credi Saison", "Star Health", "Care Health", "Niva Bupa",
  "Aditya Birla Health"
];

const extendedLoans = [
  { name: "Personal Loan", icon: Users, rate: "10.5%", startingAmt: "₹25 Lakhs", approvalTime: "24h Approval", tagline: "Collateral-free funds for personal milestones & urgent needs." },
  { name: "Business Loan", icon: Briefcase, rate: "11.2%", startingAmt: "₹1 Crore", approvalTime: "48h Approval", tagline: "Fuel your enterprise growth, buy inventory & expand scale." },
  { name: "Home Loan", icon: Building, rate: "8.4%", startingAmt: "₹5 Crore", approvalTime: "3-5 Days", tagline: "Make your dream home a reality with custom tenure options." },
  { name: "Property Loan", icon: LandmarkIcon, rate: "9.25%", startingAmt: "₹10 Crore", approvalTime: "5-7 Days", tagline: "Unlock value from your residential or commercial real estate." },
  { name: "Mortgage Loan", icon: LandmarkIcon, rate: "9.5%", startingAmt: "₹7 Crore", approvalTime: "5-7 Days", tagline: "High-value loans secured against fixed asset equity." },
  { name: "Education Loan", icon: GraduationCap, rate: "8.9%", startingAmt: "₹1.5 Crore", approvalTime: "3 Days", tagline: "Global education funding covering fees, travel & stay." },
  { name: "Professional Loan", icon: Stethoscope, rate: "10.75%", startingAmt: "₹50 Lakhs", approvalTime: "24h Approval", tagline: "Tailored credit lines for Doctors, CA, and Architects." },
  { name: "Professional Equipment Loan", icon: Cpu, rate: "11.0%", startingAmt: "₹2 Crore", approvalTime: "3 Days", tagline: "Finance medical machinery, diagnostic units & CA tech." },
  { name: "Commercial Vehicle Loan", icon: Truck, rate: "9.8%", startingAmt: "₹1.5 Crore", approvalTime: "48h Approval", tagline: "Funding for trucks, buses & corporate fleets." },
  { name: "Car Loan", icon: Car, rate: "8.7%", startingAmt: "₹50 Lakhs", approvalTime: "24h Approval", tagline: "Drive home your dream hatchback, sedan, or SUV today." },
  { name: "Hospital Funding", icon: HeartPulse, rate: "10.5%", startingAmt: "₹10 Crore", approvalTime: "7 Days", tagline: "Capital setup for clinics, diagnostics centers & hospitals." },
  { name: "Agricultural Loan", icon: Sprout, rate: "7.5%", startingAmt: "₹1 Crore", approvalTime: "3 Days", tagline: "Earthy funding for crop inputs, tractors & farm upgrades." }
];

const extendedInsurance = [
  { name: "Health Insurance", icon: Heart, premium: "₹450/mo", tagline: "Cashless coverage for medical emergencies and major illnesses.", benefits: ["100% Cashless network", "No room rent capping"] },
  { name: "Life Insurance", icon: Activity, premium: "₹650/mo", tagline: "Secure your family's future with term or endowment coverage.", benefits: ["High sum assured", "Tax benefits U/S 80C"] },
  { name: "Motor Insurance", icon: Car, premium: "₹200/mo", tagline: "Third-party and comprehensive covers for two/four-wheelers.", benefits: ["Cashless garages", "Quick claim settling"] },
  { name: "Travel Insurance", icon: Plane, premium: "₹150/trip", tagline: "Stay protected against lost baggage and medical expenses abroad.", benefits: ["Instant global support", "Baggage loss cover"] },
  { name: "Property Insurance", icon: Shield, premium: "₹500/mo", tagline: "Insure your building and household goods against fire and theft.", benefits: ["Fire & flood cover", "Burglary protection"] },
  { name: "Corporate Insurance", icon: Briefcase, premium: "₹1,200/mo", tagline: "Asset protection, liability, and employee coverage for enterprises.", benefits: ["Keyman insurance", "Asset protection"] },
  { name: "Group Insurance", icon: Users, premium: "₹250/member", tagline: "Tailored group health & life insurance schemes for workforces.", benefits: ["Easy member additions", "Corporate health plans"] }
];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <p className="text-center text-xs font-black uppercase tracking-widest text-slate-500">
              Our Elite Lending & Insurance Partners
            </p>
          </div>
            ...
            return (
              <Card key={l.name} className="p-6 border border-slate-100 bg-white shadow-md hover:shadow-elevated transition-all duration-300 hover:-translate-y-1.5 relative overflow-hidden group">
                ...
                <div className="mt-4 flex items-center justify-between pt-1">
                  ...
                  <Link to="/loans" className="text-xs text-primary font-black hover:underline flex items-center gap-1 group/btn">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <Card className="bg-gradient-to-r from-royal-purple to-lic-blue text-white p-8 rounded-2xl shadow-elevated grid md:grid-cols-12 gap-6 items-center">
          <div className="md:col-span-8 space-y-3">
            ...
            <h2 className="text-2xl font-black md:text-3xl">Check Your CIBIL Score Online</h2>
              ...
              return (
                <Card key={i.name} className="p-6 border border-slate-100 bg-white shadow-md hover:shadow-elevated transition-all duration-300 hover:-translate-y-1.5 relative overflow-hidden group">
                  ...
                  <div className="mt-4 flex items-center justify-between pt-1">
                    ...
                    <Link to="/insurance" className="text-xs text-secondary font-black hover:underline flex items-center gap-1 group/btn">
